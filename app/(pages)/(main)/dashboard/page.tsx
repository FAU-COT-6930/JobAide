...
const DashboardPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-gradient-to-br from-blue-50 via-blue-100 to-blue-200">
      <h1 className="text-3xl font-bold text-gray-800 mt-10">Your Resume PDFs</h1>

      {pdfs.length === 0 ? (
        <p className="mt-6 text-gray-600 text-lg">No Resumes found.</p>
      ) : (
